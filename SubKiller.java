...
public class SubKiller extends JPanel {
    ...
    private int countHit; // counts the number of times the bomb hit the submarine.
    private int countMiss; // Counts the number of times, the bomb missed the submarine.
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.BLACK);
        g.drawString("Number of hits:   " + countHit, 15, 24);
        g.drawString("Number of misses: " + countMiss, 15, 45);
